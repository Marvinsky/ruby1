...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { crypted_password: @login.crypted_password, email: @login.email, salt: @login.salt, username: @login.username }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { crypted_password: @login.crypted_password, email: @login.email, salt: @login.salt, username: @login.username }
    assert_redirected_to login_path(assigns(:login))
  end
